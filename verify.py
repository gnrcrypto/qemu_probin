...
def main():
    ...
    # Try to find report.json in current dir or test/ subdir
    import os
    ...
    if not os.path.exists(report_file):
        if os.path.exists('test/report.json'):
            ...
            print(f"ERROR: Could not find report.json in current directory or test/")
            return 1
    
    # Parse JSON - now properly formatted as array
